      ...
      <div className="px-[5%] xl:px-[20%]">
        <div className="flex mt-[-9rem]">
          <div className="flex flex-col justify-center">
              ...
              <div className="mb-16">
                <h2 className="mb-8 legal-title-text">Affiliate Promotions Terms & Conditions</h2>
                <p className="legal-content-text-2 ">
                  Read carefully before joining this program. You agree that you are NOT allowed to do the following things if approved for the 
                  affiliate program. By doing any of the following, you will be terminated from the program and agree that any commissions will be 
                  forfeited without recourse:
                </p>
              </div>
              
              <div className="md:px-12 lg:px-24 mb-16 md:mb-0">
                <p className="legal-content-text-2">
                  1. You are NOT permitted to conduct e-mail promotions in a 3rd party system
                  <br/>
                  ...
                  <br/><br/>
                  4. You should avoid using the raw affiliate link if you can. All affiliates are encouraged to utilize redirect links in 
                  ...
                  <br/><br/>
                  9. We run a legitimate business, which means that we always correctly illustrate and represent our products and their 
                  features and benefits to the customer. Please make sure you do the same. Anyone found using misleading claims, 
                  inaccurate information or false testimonials (or anything that does not comply with FTC guidelines) will have their 
                  affiliate account revoked immediately.
                  <br/><br/>
                  10. Vendor reserves the right to TERMINATE any affiliate if found to be breaking any rules and using 
