...
const FAQ = () => {
  ...
  return (
    <div>
      <header className="flex flex-col global-header-background-custom">
        <div className="flex flex-col items-center justify-center faq-header-container-parent">
          <h2 className="mb-6 text-center faq-header-text-1">
            About Us
          </h2>
          <h1 className="mb-6 text-center faq-header-text-2">
            Frequently Asked Questions
          </h1>
          <p className="text-center faq-content-text">
      ...
      <div className="faq-content-container">
        ...
        <div className="mb-14 faq-content-under-header">
          <a href="/">
            Home
          </a>
          <span> {`>`} </span>
          <a href="#" className="faq-category-current">
            Frequently Asked Questions
          </a>
        </div>

        <div className="flex flex-col text-center items-center">
          <h2 className="mb-6 faq-header-text-1 ">Here are our</h2>
          <h2 className="mb-6 faq-header-text-2">Frequently Asked Questions</h2>

          <p className="max-w-[720px] faq-content-text">
        ...
        <div className="flex flex-col lg:p-8 mt-8 md:mt-14">
          <Accordion className="mb-3 faq-accordion">
            ...
            <AccordionDetails className="pt-6 pb-10">
              ...
              <p className="max-w-[96%] faq-content-text">
          ...
          <Accordion className="mb-3 faq-accordion">
            ...
            <AccordionDetails className="pt-6 pb-10">
              <p className="max-w-[96%] faq-content-text">
                Go to the top menu of this page and click <span className="faq-green-text">Sign Up</span> to register for a free trial, or simple click <a href="/signup">this link</a>.
              </p>
            </AccordionDetails>
          </Accordion>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-evenly pt-14 gap-10">
          <div>
            <h2 className="faq-header-text-1">
              shineAI
            </h2>
            <h2 className="faq-header-text-2 my-2 pt-2 whitespace-nowrap">
              Vision-Mission
            </h2>
          </div>
          
          <p className="lg:max-w-[720px] faq-content-text">
